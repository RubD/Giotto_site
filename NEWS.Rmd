...
- **NEW:** Addition of tools to install, remove and check a Giotto r-miniconda environment
which is needed to run functions that require Python modules.  
  - **installGiottoEnvironment**: installs a Giotto miniconda environment  
  - **removeGiottoEnvironment**: removes a Giotto miniconda environment  
  - **checkGiottoEnvironmnet**: verifies if a Giotto environment can be found  
...
- Spatial cell type enrichment methods have been streamlined and updated  
  ...
  - **runHyperGeometricEnrich** to run enrichment using the hypergeomitric test  

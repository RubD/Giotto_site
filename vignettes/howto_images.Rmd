...
![](../inst/howtos/giotto_images/vignette_1/1_c_spatplot_image_adjusted_1.png){ width=50% }

Adjustment to the right --> with xmax_adj:  
```{r, eval=FALSE}
...
![](../inst/howtos/giotto_images/vignette_1/1_c_spatplot_image_adjusted_2.png){ width=50% }

Adjustment to the left <-- with xmin_adj:  
```{r, eval=FALSE}
...
![](../inst/howtos/giotto_images/vignette_1/1_c_spatplot_image_adjusted_3.png){ width=50% }
...
![](../inst/howtos/giotto_images/vignette_1/1_c_spatplot_image_adjusted_4.png){ width=50% }
...
![](../inst/howtos/giotto_images/vignette_1/1_c_spatplot_image_adjusted_5.png){ width=50% }
...
![](../inst/howtos/giotto_images/vignette_1/1_c_spatplot_image_adjusted_6.png){ width=50% }
...
![](../inst/howtos/giotto_images/vignette_1/1_c_spatplot_image_adjusted_7.png){ width=50% }


Simulate a left shift and compare with the OK adjustment:  
```{r, eval=FALSE}
## simulate a left shift
visium_kidney = updateGiottoImage(visium_kidney, image_name = 'image',
                                  xmax_adj = 500, xmin_adj = 2000,
                                  ymax_adj = 1000, ymin_adj = 1000)

spatPlot(gobject = visium_kidney, cell_color = 'in_tissue', show_image = T, point_alpha = 0.5)
```

![](../inst/howtos/giotto_images/vignette_1/1_c_spatplot_image_adjusted_8.png){ width=50% }
...
![](../inst/howtos/giotto_images/vignette_1/1_c_spatplot_image_adjusted_9.png){ width=50% }
...
![](../inst/howtos/giotto_images/vignette_1/1_c_spatplot_image_adjusted_10.png){ width=50% }

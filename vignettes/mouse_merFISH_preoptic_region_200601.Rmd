...
instrs = createGiottoInstructions(save_dir = '/your/results/path/', save_plot = T)
```
...
expr = readExprMatrix(paste0(data_dir, '/', 'count_matrix/merFISH_3D_data_expression.txt'))
cell_loc = data.table::fread(paste0(data_dir, '/', 'cell_locations/merFISH_3D_data_cell_locations.txt'),select = 2:4)
cell_type = data.table::fread(paste0(data_dir, '/', 'cell_types/merFISH_3D_data_cell_types.txt'), select = 2)
```
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/2_a_gene_distribution.png){ width=50% } 

```{r, eval=FALSE}
filterDistributions(merFISH_test, detection = 'cells')
```

![](../inst/images/mouse_merFISH_hypoth/vignette_200601/2_b_cells_distribution.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/2_c_filter_combos.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/2_spatial_locations2D.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/1_screenshot_spatial_locations.png){ width=50% } 

## part 3: dimension reduction

```{r, eval=FALSE}
# only 155 genes, use them all (default)
merFISH_test <- runPCA(gobject = merFISH_test, genes_to_use = NULL, scale_unit = F, center = F)
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/2_screenshot_UMAP_reduction.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/3_screenshot_leiden.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/4_screenshot_covisualization.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/5_leiden_2D.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/5_violinplot.png){ width=50% } 
...
cluster_order = c(1, 2, 3, 5, 7, 8, 4, 9, 12, 10, 11, 6)
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/7_clusterheatmap_markers.png){ width=50% } 


```{r, eval=FALSE}
## name clusters
clusters_cell_types_hypo = c('Inhibitory', 'Inhibitory', 'Excitatory','OD Mature','OD Mature', 'OD Immature', 
                             'Astrocyte', 'Astrocyte', 'Microglia', 'Ependymal', 'Endothelial','Endothelial')
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/7_clusterheatmap_markers_celltypes.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/7_umap_cell_types.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/7_spatPlot_cell_types_all.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/7_spatPlot2D_cell_types_all.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/7_spatPlot_cell_types_excit.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/7_spatPlot2D_cell_types_excit.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/7_spatPlot_cell_types_inhib.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/7_spatPlot2D_cell_types_inhib.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/7_spatPlot_cell_types_ODandAstro.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/7_spatPlot2D_cell_types_ODandAstro.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/7_spatPlot_cell_types_other.png){ width=50% } 
...
![](../inst/images/mouse_merFISH_hypoth/vignette_200601/7_spatPlot2D_cell_types_other.png){ width=50% } 

...
- 6. Annotate clusters  
- 7. Create a Spatial grid or Network  
- 8. Find genes with a spatially coherent gene expression pattern
- 9. Identify genes that are spatially co-expressed
- 10. Explore spatial domains with HMRF  
- 11. Calculate spatial cell-cell interaction enrichment  
- 12. Find cell-cell interaction changed genes (ICG)  
- 13. Identify enriched or depleted ligand-receptor interactions in hetero and homo-typic cell interactions  
- 14. Export Giotto results to use in Giotto viewer
